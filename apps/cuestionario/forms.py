...
class CuestionarioForm(forms.ModelForm):
    ...
    class Meta:
        ...
        widgets = {
                  ...
                  'situacion' :  forms.CheckboxSelectMultiple(),
                  'manifestaciones' :  forms.CheckboxSelectMultiple(),
                  'infecciones' :  forms.CheckboxSelectMultiple(),
                  'neoplasias' :  forms.CheckboxSelectMultiple(),
        }